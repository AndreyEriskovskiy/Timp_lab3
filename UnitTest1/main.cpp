...
SUITE(EncryptTest)
{
    ...
    TEST_FIXTURE(KeyBoba_fixture, AlphaUp) {
        wstring open_text=L"БЭБРАБОЙ";
        wstring res=L"БЮПСАБПШ";
        
        CHECK_EQUAL(true,res==p->encrypt(open_text));
    }
    
    TEST_FIXTURE(KeyBoba_fixture, AlphaDown) {
        wstring open_text=L"бэбрабой";
        wstring res=L"БЮПСАБПШ";
...
{
    TEST_FIXTURE(KeyBoba_fixture, AlphaUp) {
        wstring cipher_text=L"БЮПСАБПШ";
        wstring res=L"БЭБРАБОЙ";
        
        CHECK_EQUAL(true,res==p->decrypt(cipher_text));
    }
