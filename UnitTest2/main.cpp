...
SUITE(DecryptTest)
{
    ...
    TEST(AlphaUp) {
        ...
        CHECK_EQUAL("TEXTIK", cipher.decrypt("I T X E TK", key));
    }
    ...
    TEST(SignesInText) {
        ...
        CHECK_EQUAL("Hello, world", cipher.decrypt("or lo lw e dH,l", key));
    }
    ...
    TEST(digits) {
        ...
        CHECK_EQUAL("88005553535", cipher.decrypt("53 05 03 85 855", key));
    }

    TEST(NoAlpha) {

        CHECK_EQUAL("555+777", cipher.decrypt("7 + 5 5757", key));
    }
